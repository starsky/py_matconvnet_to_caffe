...
test_case_resnet50_flow = test_data/ucf101-TVL1flow-resnet-50-split1/
...
prep_data:
	...
	py_matconv_to_caffe/matlab_scripts/py_matconv2caffe_prepare_test_data $(test_case_resnet50_flow)/net.mat $(test_case_resnet50_flow)/test_frames $(test_case_resnet50_flow)/workspace $(matconv_net_dir)
